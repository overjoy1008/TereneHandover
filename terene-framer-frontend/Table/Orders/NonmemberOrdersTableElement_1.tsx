// // NonmemberOrdersTableElement.tsx
// import React, { useState } from "react" // 이미 되어 있다면 생략
...
// export function NonmemberOrdersTableElement({
//     data,
//     viewMode = "desktop",
//     onUpdateOrder,
//     onOpenDetail,
...
//         const url = new URL("https://terene.kr/reservation-3-custom-guest")
...
//                 >
//                     예약일자:{" "}
//                     {formatTimestamp(data.reservation_status_timestamp)}
//                 </div>
//                 <div
//                     style={{
//                         display: "flex",
